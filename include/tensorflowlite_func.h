...
public:
  Expect<uint64_t> body(const Runtime::CallingFrame &CallFrame,
...
public:
  Expect<uint32_t> body(const Runtime::CallingFrame &CallFrame,
                        uint64_t Tensor);
};
...
public:
  Expect<void> body(const Runtime::CallingFrame &CallFrame, uint64_t Tensor,
                    uint32_t BufPtr);
};

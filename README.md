...
```bash
wget https://github.com/second-state/WasmEdge-tensorflow-deps/releases/download/0.10.1-alpha.1/WasmEdge-tensorflow-deps-TF-0.10.1-alpha.1-manylinux2014_x86_64.tar.gz
tar -zxvf WasmEdge-tensorflow-deps-TF-0.10.1-alpha.1-manylinux2014_x86_64.tar.gz
rm -f WasmEdge-tensorflow-deps-TF-0.10.1-alpha.1-manylinux2014_x86_64.tar.gz
...
wget https://github.com/second-state/WasmEdge-tensorflow-deps/releases/download/0.10.1-alpha.1/WasmEdge-tensorflow-deps-TFLite-0.10.1-alpha.1-manylinux2014_x86_64.tar.gz
tar -zxvf WasmEdge-tensorflow-deps-TFLite-0.10.1-alpha.1-manylinux2014_x86_64.tar.gz
rm -f WasmEdge-tensorflow-deps-TFLite-0.10.1-alpha.1-manylinux2014_x86_64.tar.gz
```
